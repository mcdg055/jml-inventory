<template>
    ...
    <page-layout pageHeading="Receive a Supply" title="Supplies">
        <div class="flex flex-col gap-5">
            ...
            <selected-inventory-items-table :inventory_items="form.items" :errors="form.errors"
                @computed-total="updateTotal" @delete-item="handleDeleteItem" />
...
function handleSubmit() {
    ...
    axios.post('/supplies/store', form).then((response) => {
        Inertia.post('/supplies', {
            flash:
